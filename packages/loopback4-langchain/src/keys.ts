...
export namespace LangChainBindings {
  ...
  export const OUTPUT_PARSER =
    BindingKey.create<any>('services.OutputParser') as BindingKey<BaseOutputParser>;

  /**
   * Binding key for Chat Model
   */
  export const CHAT_MODEL: BindingKey<BaseChatModel> =
    BindingKey.create('services.ChatModel') as BindingKey<BaseChatModel>;
...
export const REDIS_CHAT_MESSAGE_HISTORY = LangChainBindings.REDIS_CHAT_MESSAGE_HISTORY;
export const OUTPUT_PARSER = LangChainBindings.OUTPUT_PARSER;
export const CHAT_MODEL: BindingKey<BaseChatModel> = LangChainBindings.CHAT_MODEL;
